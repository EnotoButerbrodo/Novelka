...
namespace Kursovaya.Playback.ResourcesControl
{
    ...
    {
        public static BitmapImage GetImage(string zipPath, string fileName)
        {
            var buff = LoadFile(zipPath, fileName);
            return ConvertToBitmapImage(buff);
        }

        public static MemoryStream LoadFile(string zipPath, string fileName)
        ...
        public static MemoryStream[] LoadFiles(string zipPath, string[] filesName)
        {
